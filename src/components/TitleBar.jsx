    ...
    <div className="flex flex-col sm:flex-row justify-between">
      {isCheck.length > 0 ? (
        <>
          <div className="mb-[0.125rem] block min-h-[1.5rem]">
            <Checkbox
              ...
              ref={(input) =>
                input && (input.indeterminate = checkIsIntermediate())
              }
            />
            <label
          ...
          <div>
            <button
              ...
              className="bg-white border-0 text-red-600"
            >
              Delete Files
            </button>
          </div>
        ...
        <>
          ...
          <div className="flex flex-row-reverse sm:flex-row items-center justify-end gap-2 text-sm text-gray-500">Upload images to your gallery<span><ExclamationCircleIcon className="h-4 w-4"/></span></div>
        </>
      )}
    </div>
  );
